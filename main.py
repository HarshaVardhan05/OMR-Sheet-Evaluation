...
webCamFeed = False
pathImage = "C:/Users/Nani/Desktop/OMR Project/sheet2.jpg"
...
while True:
    ...
    try:
        ...
        cv2.drawContours(imgContours, contours, -1, (20,20,20), 10)  # DRAW ALL DETECTED CONTOURS
        ...
        if biggestPoints.size != 0 and gradePoints.size != 0:
            ...
            cv2.drawContours(imgBigContour, biggestPoints, -1, (0, 0, 102), 20)  # DRAW THE BIGGEST CONTOUR
            ...
            cv2.drawContours(imgBigContour, gradePoints, -1, (102, 0, 51), 20)  # DRAW THE BIGGEST CONTOUR
            ...
            cv2.putText(imgRawGrade, str(int(score)) + "%", (100, 100)
                        , cv2.FONT_HERSHEY_COMPLEX, 2, (0, 255, 127), 3)  # ADD THE GRADE TO NEW IMAGE
    ...
    # LABELS FOR DISPLAY
    lables = [["Original OMR", "Gray scale", "Detected Edges", "Contours"],
              ["Biggest Contour", "Threshold", "Warpped", "Final OMR"]]
